/*************************************************************
 * Project Name   : Abroad Studies Management
 * GitHub Link    : https://github.com/anaghajk25/Abroad_studies.cpp
 * Author         : Anagha
 * Date           : 22-09-2025
 * Description    : 
 *   This C++ project is a master menu system for managing 
 *   student applications for studying abroad. It includes 
 *   10 individual programs demonstrating key OOP concepts 
 *   like function overloading, operator overloading, 
 *   constructors, static members, friend functions, and 
 *   multiple/multilevel inheritance. 
 *
 * Programs Included:
 *   1. Basic Application Form
 *       - Collects student information and provides a GPA-based eligibility check.
 *   2. Function Overloading
 *       - Demonstrates function overloading for displaying student details.
 *   3. Friend Function
 *       - Shows usage of friend function to access private members.
 *   4. Parameterized Constructor
 *       - Demonstrates object initialization via constructor.
 *   5. Static Members
 *       - Tracks total students, checks visa eligibility, and lists popular universities.
 *   6. Function Overloading and Data Input
 *       - Overloaded display functions to show student details with varying parameters.
 *   7. Operator Overloading
 *       - Custom increment, decrement, and logical operations for student eligibility.
 *   8. Operator Overloading for Class Objects
 *       - Combines application counts of different students using overloaded '+' operator.
 *   9. Multi-level Inheritance
 *       - Demonstrates inheritance from Student ? Application ? Visa classes.
 *  10. Multiple Inheritance
 *       - Combines Student and Course classes into a full AbroadApplication class.
 *
 * How to Run:
 *   1. Compile the program:
 *        g++ Abroad_studies.cpp -o AbroadApp
 *   2. Run the program:
 *        ./AbroadApp
 *   3. Use the master menu to select which program to run.
 *
 * Notes:
 *   - Input validation is partially included (e.g., age >= 18 for program 10).
 *   - The project demonstrates both beginner and intermediate C++ OOP concepts.
 *   - Each program function is modular and can also be used separately.
 *
 * Example Usage:
 *   - Run the program and select option 1:
 *       Enter student details ? Program prints eligibility.
 *   - Select option 5:
 *       Add multiple students and check total count.
 *
 * Learning Outcomes:
 *   - Understand OOP concepts: classes, objects, constructors, destructors.
 *   - Practice function overloading and operator overloading.
 *   - Implement friend functions and static members.
 *   - Learn multiple and multi-level inheritance.
 *   - Apply modular programming techniques for larger projects.
 *************************************************************/
